...
if (isset($_POST['up'])) {
    ...
    $Name = $_POST['Course_Name']; // Corrected variable name
    $Teacher = $_POST['Course_Teacher']; // Corrected variable name

    // Update the course in the database
    $gms = $connection->prepare("UPDATE courses SET Course_Name=?, Course_Teacher=? WHERE Course_Id=?");
    $gms->bind_param("ssdssi", $Name, $Teacher $course_Id);
    $gms->execute();
